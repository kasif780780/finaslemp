...
namespace EmpManager.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "TicketID,TicketSubject,CreatedDate,priorty,Status,EmployeeID")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "TicketID,TicketSubject,CreatedDate,priorty,Status,EmployeeID")] Ticket ticket)
        {
            if (ModelState.IsValid)
            {
